...
public class RoleServiceImpl implements RoleService {
    ...
    public Map<Integer, String> createRole(Role role) {
        ...
        Role retrievedRole=roleMapper.findByName(role.getName().toUpperCase());
    ...
    public Map<Integer, String> updateRole(Role role) {
        ...
        if (!role.getName().isEmpty()) {
            Role instantRole = roleMapper.findByName(role.getName().toUpperCase());//check whether the given role name already exists in the db
            if (instantRole != null) {
